...
This stage allows the user to input CSV file to allow the exported data to be labelled properly, without the user ahving to manually check and label the outputs. If the objects do not require labeling, you can skip to stage 3. 
